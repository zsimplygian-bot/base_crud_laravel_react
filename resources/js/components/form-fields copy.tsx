                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      formData.append("view", view); // 👈 SE ENVÍA LA VIEW
                      try {
                        ...
                        setData(fieldKey, result.filename); // 👈 SOLO nombre, no la URL completa
                      } catch (error) {
                        alert("Error subiendo archivo");
                        console.error(error);
                      }
